// pages/operateHistory/operateHistory.js
...
Page({
  ...
  input(e){
   ...
   goto_addOperateDairy(){
     wx.navigateTo({
       url: '/todayDairy/pages/addOperateDairy/addOperateDairy',
     })
   },
  ...
  getdata(){
    utils.myRequest({
      url:`localserver/operateHistory`,
      method:'GET'
    }).then(res =>{
